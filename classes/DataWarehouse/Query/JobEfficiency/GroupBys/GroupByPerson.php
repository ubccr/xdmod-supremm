...
class GroupByPerson extends \DataWarehouse\Query\JobEfficiency\GroupBy
{
    ...
    {
        return "A person who is on a PIs allocation.";
    }
    ...
    {
        return parent::pullQueryParameterDescriptions2($request, "select long_name as field_label from modw.person  where id in (_filter_) order by order_id");
    }
