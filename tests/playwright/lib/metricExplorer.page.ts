...
class MetricExplorer extends BasePage{
    ...
    async addDataViaMenu(maskName, n) {
        ...
        const addDataButton = this.page.locator(this.addDataButton);
        await addDataButton.click();

        const jobsMenuItem = this.page.locator(this.toolbar.addData('Jobs'));
        await expect(jobsMenuItem).toBeVisible();
        await jobsMenuItem.click();

        const groupByItem = this.page.locator(this.toolbar.addDataGroupBy(n));
