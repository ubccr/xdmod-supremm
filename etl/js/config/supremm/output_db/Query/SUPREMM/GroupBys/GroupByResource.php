...
class GroupByResource extends \DataWarehouse\Query\SUPREMM\GroupBy
{
	...
	{		
		...
		$resourcefact_shortname_field = new \DataWarehouse\Query\Model\FormulaField("replace(rf.$this->_short_name_field_name,'-',' ')", $this->getShortNameColumnName($multi_group)); 
